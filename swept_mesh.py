...
def add_local_hec_vertical_refinement(
    ...
    The point cloud is aligned with the HEC strike/width axes and uses the same XY
    lattice on every z level, creating a swept-like matched layer topology. It is
    excluded wherever the normal
